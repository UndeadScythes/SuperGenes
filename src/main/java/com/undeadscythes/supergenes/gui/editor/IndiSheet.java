 ...
 */
public class IndiSheet extends JPanel {
    ...
    /**
     * Creates new form IndiSheet
     */
    public IndiSheet(final GeneBase geneBase, final SuperGenesGUI gui) {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        indi.add(new Fact(Tag.NAME.getGEDTag(), jTextField1.getText() + " /" + jTextField2.getText() + "/"));
        indi.add(new Fact(Tag.SEX.getGEDTag(), (jRadioButton1.isSelected() ? "M" : (jRadioButton2.isSelected() ? "F" : "U"))));
